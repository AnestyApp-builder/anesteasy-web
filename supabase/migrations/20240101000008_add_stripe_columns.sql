-- Migration: Adicionar colunas do Stripe na tabela subscriptions
-- Data: 2024-01-01
-- Descrição: Adiciona suporte ao Stripe substituindo Pagar.me
...
-- Nota: As colunas antigas do Pagar.me são mantidas para compatibilidade com dados existentes
-- mas não devem ser mais usadas em novas assinaturas
